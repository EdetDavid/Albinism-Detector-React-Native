      ...
      <View style={styles.card}>
        <View style={styles.cardContent}>
          ...
          <Text style={styles.description}>
            This project aims at detecting albinism using advanced genetic data
            analysis. By analyzing specific genetic markers, our sophisticated
            algorithm provides accurate insights into an individual's likelihood
            of having albinism.
          </Text>
